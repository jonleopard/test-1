...
func run(logger *slog.Logger) error {
	...
	flag.StringVar(&cfg.cookie.secretKey, "cookie-secret-key", "c5ld4fkuaxtuae6a4mb36ngwbs2wsgnc", "secret key for cookie authentication/encryption")
	...
	flag.StringVar(&cfg.session.secretKey, "session-secret-key", "jnz4wc5veyj6f6j5ixetsyn2ahfovzje", "secret key for session cookie authentication")
